...
root_menu = RootNoteMenu((0,600),(1400, 100), ROOT_NOTE_BUTTON_SIZE, Colours.RNM_BG_COLOR, Colours.BUTTON_COLOR)
root_menu.drawMenu(win)

scales_menu = ScalesMenu((1400,0), (400,700), 40, Colours.SCALES_BG_COLOR, Colours.BUTTON_COLOR)
